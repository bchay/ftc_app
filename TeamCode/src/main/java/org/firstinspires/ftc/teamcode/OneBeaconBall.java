...
@Autonomous(name = "One Beacon Ball", group = "Main Code")
public class OneBeaconBall extends OpModeBase { //Robot starts aligned with wall
    public void runOpMode() {
        ...
        //First Beacon
        move(12, moveSpeed);
        turn(48, moveDirection, turnSpeed, -1); //Adjust twice
